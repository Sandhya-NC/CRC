...
public class ImportPrivacyGuard extends BasePageCrc
{
	
	public ImportPrivacyGuard(WebDriver driver) 
	{
		super(driver);
...
//		First 
		searchreportproviders.sendKeys("PrivacyGuard");
		String privacyguardtext = privacyguard.getText();
		privacyguard.click();
		System.out.println(privacyguardtext +"is selected");
